...
public class ScheduleMainDto {
	...
	private String mouldTgCompleteDate;
	private String mouldActCompleteDate;
	...
	public String getMouldTgCompleteDate() {
		return mouldTgCompleteDate;
	}
	public void setMouldTgCompleteDate(String mouldTgCompleteDate) {
		this.mouldTgCompleteDate = mouldTgCompleteDate;
	}
	public String getMouldActCompleteDate() {
		return mouldActCompleteDate;
	}
	public void setMouldActCompleteDate(String mouldActCompleteDate) {
	...
	public String getProdSignDate() {
		return prodSignDate;
	}
	public void setProdSignDate(String prodSignDate) {
	...
	public List<ScheduleDetailDto> getDetails() {
		return details;
	}
	public void setDetails(List<ScheduleDetailDto> details) {
